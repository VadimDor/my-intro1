...
<tr>
    <td align="center">
        <a href="https://github.com/sample">
            <img src="/assets/profile.<PEXT>" width="80;" alt="sample"/>
            <br />
            <sub><b>sample</b></sub>
        </a>
    </td>
...
<tr>
    <td align="center">
        <a href="https://github.com/<YOUR GIT USERNAME>">
            <img src="/assets/profile.<PEXT>" width="80;" alt="<YOUR GIT USERNAME>"/>
            <br />
...
[![Recent Star Gazers](https://reporoster.com/stars/dark/<YOUR GIT USERNAME>/asdf-<YOUR TOOL LC>)](<TOOL REPO>/stargazers)

[![Recent Forkers](https://reporoster.com/forks/dark/<YOUR GIT USERNAME>/asdf-<YOUR TOOL LC>)](<TOOL REPO>/network/members)

---

## Dependencies

This project definitely wouldn't have been quite so possible without the making use of the following package and components. Full credit and big kudos to their respective authors, who've done an amazing job in building and maintaining them. For a full breakdown of dependency licenses, please see [ACKNOWLEDGMENTS](<TOOL REPO>/blob/<PRIMARY BRANCH>/ACKNOWLEDGMENTS.md)

### Core

The application linting is done with [**ESLint**](https://github.com/eslint/eslint) and [**Prettier**](https://prettier.io/), both following the [**AirBnB Styleguide**](https://github.com/airbnb/javascript). Some configs are defined in [**YAML**](https://github.com/yaml/yaml), with a simple [**Node.js**](https://github.com/nodejs/node) server to serve up the static app and the optional API endpoints, and container deployment and testing is done with [**Docker**](https://www.docker.com/).


### External Services

 Code is hosted on [GitHub](https://github.com) and Docker images are hosted on [DockerHub](https://hub.docker.com/).
...
Would you like to be listed here? Whatever your skill set, <PROJECT NAME> needs people like you to help support future development. Check out the [Contributing Page](/contributing.md) for ways that you can get involved. Huge thank you to everyone who has already contributed! 💖
